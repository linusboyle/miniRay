...
int main() {
    ...
    assert(( a / 2.0 == Vector3{0.5, 0.0, 0.0} ));
    ...
    s.addObject(sphere);
    s.addObject(new Sphere{Point{-1.9, 1.1, 0.0}, 1, {100.0 / 255.0, 20.0 / 255.0, 35.0 / 255.0} });
    s.addObject(new Plane{ Point{1.0, 0.0, -1.0}, Point{0.0, 1.0, -1.0}, Point{0.0, -1.0, -1.0}, {70.0 / 255.0, 70.0 / 255.0, 70.0 / 255.0}, true});
