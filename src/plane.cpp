...
namespace graphics {
Plane::Plane(Point p, Vector3 normal, RGBColor color, RGBColor emission, SurfaceProperty property)
    : Surface(color, emission, property), p_(std::move(p)), normal_(std::move(normal)) {}
