...
min3(coordinate_type a, coordinate_type b, coordinate_type c)
{
...
static coordinate_type
max3(coordinate_type a, coordinate_type b, coordinate_type c)
{
  coordinate_type tmp = std::max(a, b);
  return std::max(tmp, c);
}

Triangle::Triangle(Point a_,
                   Point b_,
                   Point c_,
                   RGBColor color,
                   bool reflective)
...
Vector3
Triangle::computeNormal(Ray ray) const
{
...
{
  return { Point{ min3(a(0), b(0), c(0)),
                  min3(a(1), b(1), c(1)),
                  min3(a(2), b(2), c(2)) },
           Point{ max3(a(0), b(0), c(0)),
                  max3(a(1), b(1), c(1)),
